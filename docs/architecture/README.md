...
| `sistema-escolar.architecture.json` | pergunta pessoal do aluno → telefone confiável → API Laravel → contrato Zod → desambiguação por nome completo → resposta sem identificador interno |
