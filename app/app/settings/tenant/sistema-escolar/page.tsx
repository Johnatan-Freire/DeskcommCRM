 ...
 * anon` (migration 0169) — nenhum client de sessão a lê, nem com RLS a favor. Por
...
export default async function SistemaEscolarConfigPage() {
  ...
  return (
    <div className="flex h-full flex-col gap-6 p-6">
      <header>
        <h1 className="text-2xl font-semibold tracking-tight">Sistema escolar</h1>
        <p className="text-sm text-muted-foreground">
          A URL e a chave da API do sistema escolar (Capital Code) que os agentes
          &ldquo;Alunos&rdquo; e &ldquo;Interessados&rdquo; consultam para matrícula,
          notas, frequência e catálogo de cursos. A chave é cifrada e nunca volta a
          aparecer na tela depois de salva.
        </p>
      </header>
