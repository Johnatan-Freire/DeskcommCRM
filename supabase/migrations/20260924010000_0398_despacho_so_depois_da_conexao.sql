-- ============================================================================
-- 0398 — O AGENTE NÃO PODE RESPONDER MENSAGEM DE ANTES DE CONECTAR
--
-- Numerada 0398 (não 0281): o upstream já usa 0281 para outra migration
-- (`conversa_do_caso`) na base em que este fork foi atualizado (v1.47.0).
--
-- ═══ O RISCO ═══
--
